 ...
 * identically to a genuinely organization-less user; callers use this predicate
 * to tell the two apart and prompt a re-login instead of showing a silent empty
